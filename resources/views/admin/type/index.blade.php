      ...
      <div class="row mt-5">
          ...
          <div class="card bg-default shadow">
            <div class="card-header bg-transparent border-0">
              ...
              <h3 class="text-white mb-0">Type Table</h3><br> <a href="{{ route('admin.type.create') }}" class="btn btn-success btn-sm"><i class="ni ni-fat-add"></i>Add New</a>
            </div> 
              ...
              <table class="table align-items-center table-dark table-flush">
                ...
                <tbody>
                      ...
                      <tr scope="row">
                          ...
                          <td>{{ $type->recommendation->name }}</td>
