...
<head>
  ...
  <title>Homepage | Leave Management</title>
  <!-- Favicon -->
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-6 col-md-6">
              ...
              <p class="text-lead text-light">You can Manage and Organize Leave of your Employee Login to Access</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container mt--9 pb-4">
      <div class="row justify-content-center">
        <div class="col-lg-10 col-sm-4">
          ...
          <img src="{{ asset('frontend/img/brand/homepage.jpg') }}" style=" max-width: 100%;
    height: auto;">
